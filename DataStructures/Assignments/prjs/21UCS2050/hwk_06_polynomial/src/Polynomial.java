 ...
 * Description: Homework 06 - Polynomial
 */
...
public class Polynomial {
    ...
    public int degree() {
        ...
        while(current != null){
            if(current.getExponent() > currDegree){
                currDegree = current.getExponent();
            }
    ...
    // TODO #2: traverse the callee polynomial and call toString from each of its terms to generate
