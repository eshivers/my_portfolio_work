 ...
 * Description: Activity 05 - FractionTest
 */
...
public class FractionTest {
    ...
    @Test
    public void testZeroOverNegativeOne() {
        // case 1
    ...
    @Test
    public void testNegativeOneOverZero() {
        // case 1
        Fraction f1 = new Fraction(-1, 0);
        assertEquals(-1, f1.getNumerator());
        assertEquals(1, f1.getDenominator());
    ...
    @Test
    public void testNegativeOneOverOne() {
        // case 1
    ...
    @Test
    public void testOneOverNegativeOne() {
        // case 1
    ...
    @Test
    public void testNegativeOneOverNegativeOne() {
        // case 1
        Fraction f1 = new Fraction(-1, -1);
        assertEquals(-1, f1.getNumerator());
        assertEquals(-1, f1.getDenominator());
    ...
    @Test
    public void testNegative24Over54() {
        // case 1
        Fraction f1 = new Fraction(-24, 54);
        assertEquals(-24, f1.getNumerator());
        assertEquals(54, f1.getDenominator());
    ...
    @Test
    public void test24OverNegative54() {
        // case 1
        Fraction f1 = new Fraction(24, -54);
        assertEquals(24, f1.getNumerator());
        assertEquals(-54, f1.getDenominator());
    ...
    @Test
    public void testNegative24OverNegative54() {
        // case 1
        Fraction f1 = new Fraction(-24, -54);
        assertEquals(-24, f1.getNumerator());
        assertEquals(-54, f1.getDenominator());
    ...
    @Test
    public void testNegative54Over24() {
        // case 1
        Fraction f1 = new Fraction(-54, 24);
        assertEquals(-54, f1.getNumerator());
        assertEquals(24, f1.getDenominator());
    ...
    @Test
    public void test54OverNegative24() {
        // case 1
        Fraction f1 = new Fraction(54, -24);
        assertEquals(54, f1.getNumerator());
        assertEquals(-24, f1.getDenominator());
    ...
    @Test
    public void testNegative54OverNegative24() {
        // case 1
        Fraction f1 = new Fraction(-54, -24);
        assertEquals(-54, f1.getNumerator());
        assertEquals(-24, f1.getDenominator());
